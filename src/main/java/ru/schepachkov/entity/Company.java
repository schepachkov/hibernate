...
public class Company {
    ...
    @OneToMany(mappedBy = "company", orphanRemoval = true, cascade = CascadeType.ALL)// mappedBy - используется для установки двунаправленной связи - ссылаемся на имя поля в классе User
